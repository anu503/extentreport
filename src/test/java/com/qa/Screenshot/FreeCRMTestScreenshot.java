...
public class FreeCRMTestScreenshot {
	...
	public void setExtent(){
		...
		extent.addSystemInfo("Host Name", "LAPTOP-0JF24479");
		extent.addSystemInfo("User Name", "Danda");
	...
	public void freeCrmTitleTest(){
		...
		public void tearDown(ITestResult result) throws IOException{
			...
			if(result.getStatus()==ITestResult.FAILURE){
				...
				String screenshotPath = FreeCRMTestScreenshot.getScreenshot(driver, result.getName());
